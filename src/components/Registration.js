  ...
  return (
    <div
      className={`flex flex-row ${
        accountType === "hospital" ? "bg-sky-100" : "bg-rose-100"
      }`}
    >
      <div className="flex-1 m-1 p-5 w-[50px] h-[1200px] items-center flex flex-col rounded-3xl">
        <form
          onSubmit={handleSubmit}
          className={`flex flex-col gap-3 p-4 text-justify border-1 border-black rounded-3xl ${
            accountType === "hospital" ? "bg-green-400" : "bg-sky-950"
          } w-[500px]`}
        >
          <div
            className={`text-center ${
              accountType === "hospital" ? "text-black" : "text-white"
            } text-3xl mb-4`}
          >
            <h3>Registration</h3>
          </div>
          ...
          <div className="flex gap-4 mt-4 justify-center">
            <button
              className={`w-full md:w-[120px] h-[40px] ${
                accountType === "hospital"
